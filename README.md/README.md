...
A financial statement analysis project demonstrating core Financial Analyst skills — 
ratio analysis, trend and variance analysis, distress detection, and forecast 
reliability testing — using real 10-K-based financial data across 12 major public 
companies spanning Technology, Banking, Finance, Retail, and Utilities.
...
**1. Cleaning** — standardized inconsistent category labels (e.g., `BANK` → `Bank`)
